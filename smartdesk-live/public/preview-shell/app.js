...
function renderSettings() {
  ...
  const modulesSummary = `
    <div class="module-state-grid">
      ${renderModuleStateCard({ key: "marketing", title: currentLanguage() === "en" ? "Marketing" : "Marketing", enabledCopy: currentLanguage() === "en" ? "Recall, triggers and operational lists are active." : "Recall, trigger e liste operative.", lockedCopy: currentLanguage() === "en" ? "Enable the module to open recalls, triggers and lists." : "Attiva il modulo per aprire recall, trigger e liste." })}
      ${renderModuleStateCard({ key: "treatments", title: currentLanguage() === "en" ? "Treatments" : "Trattamenti", enabledCopy: currentLanguage() === "en" ? "Paths, protocols and service shell are active." : "Percorsi, protocolli e shell servizi.", lockedCopy: currentLanguage() === "en" ? "Enable treatments to connect paths and protocols." : "Attiva trattamenti per collegare percorsi e protocolli." })}
      ${renderModuleStateCard({ key: "cashdesk", title: currentLanguage() === "en" ? "Cash desk" : "Cassa", enabledCopy: currentLanguage() === "en" ? "Checkout, payment history and revenue are active." : "Checkout, storico pagamenti e incassi.", lockedCopy: currentLanguage() === "en" ? "Enable cash desk to unlock checkout and payment history." : "Attiva cassa per sbloccare checkout e storico pagamenti." })}
      ${renderModuleStateCard({ key: "protocols", title: currentLanguage() === "en" ? "Protocols hub" : "Hub protocolli", enabledCopy: currentLanguage() === "en" ? "Method, operational guidance and AI draft are active." : "Metodo, guida operativa e bozza AI.", lockedCopy: currentLanguage() === "en" ? "Enable protocols to connect method and operational guidance." : "Attiva protocolli per collegare metodo e guida operativa." })}
      ...
      ${renderModuleStateCard({ key: "shiftsTemplates", title: currentLanguage() === "en" ? "Shift templates" : "Template turni", enabledCopy: currentLanguage() === "en" ? "Templates and operational setup are active." : "Schemi e configurazione operativa.", lockedCopy: currentLanguage() === "en" ? "Enable templates to structure recurring shifts." : "Attiva template per strutturare i turni ricorrenti." })}
      ...
      ${renderModuleStateCard({ key: "profitability", title: currentLanguage() === "en" ? "Profitability" : "Redditivita", enabledCopy: currentLanguage() === "en" ? "Margins, alerts and economic analysis are active." : "Margini, alert e analisi economica.", lockedCopy: currentLanguage() === "en" ? "Enable profitability to read margins and alerts." : "Attiva redditivita per leggere margini e alert." })}
