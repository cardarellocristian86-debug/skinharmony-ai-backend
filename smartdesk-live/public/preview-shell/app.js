...
function renderSettings() {
  ...
  const modulesSummary = `
    <div class="module-state-grid">
      ...
      ${renderModuleStateCard({ key: "protocols", title: currentLanguage() === "en" ? "Protocols hub" : "Centro protocolli", enabledCopy: currentLanguage() === "en" ? "Manual method and operational guidance are active. AI drafting is in standby." : "Metodo manuale e guida operativa sono attivi. La bozza AI è in standby.", lockedCopy: currentLanguage() === "en" ? "Enable protocols to connect method and operational guidance." : "Attiva protocolli per collegare metodo e guida operativa." })}
