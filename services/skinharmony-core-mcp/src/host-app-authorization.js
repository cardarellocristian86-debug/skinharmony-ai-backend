...
export function requiredHostAppCapabilityForTool(toolName, args = {}, tools = []) {
  ...
  if (["entity_360_shadow_enable", "entity_360_enforce_enable",
    "entity_360_shadow_disable", "nyra_autopilot_enable"]
    .includes(name)) {
...
export function requireHostAppToolCapability({
  ...
  const governedOperationCapability = target === "nyra_continue"
    ? {
        ...
        reevaluate_native_closure: HOST_APP_CAPABILITIES.WORK_OPERATE,
