...
function tool(name, title, description, inputSchema, readOnly, { boundedCollaboration = false } = {}) {
  const schema = {
    ...inputSchema,
    properties: {
      ...inputSchema.properties,
      ...presence,
      ...(!readOnly && !boundedCollaboration ? ownerProperties : {}),
    },
  };
  return {
