...
const definitions = [
  ...
  ["intent_revision_approve", "Approve intent revision", "Apply the required Core or owner authority to a proposed intent revision.", object({ project_id: identifier, intent_revision_id: identifier, approved: { type: "boolean" }, expected_no_active_intent: { type: "boolean" }, idempotency_key: identifier }, ["project_id", "intent_revision_id", "approved", "idempotency_key"]), false],
