...
export const TOOLS = [
  ...
  tool("tenant_provider_openai_setup_link", "Create secure OpenAI provider setup link", "Create a short-lived, one-time setup link for the authenticated tenant. Open this link yourself to enter an OpenAI API key directly into the encrypted tenant vault; never paste a key into ChatGPT or Codex. Creating a link does not enable model execution.", object({
    ttl_minutes: { type: "integer", minimum: 5, maximum: 30 },
  }), ["core:govern"], false, false),
