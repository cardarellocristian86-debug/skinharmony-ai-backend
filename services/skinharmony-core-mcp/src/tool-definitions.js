...
export const TOOLS = [
  ...
  tool("tenant_provider_openai_status", "Check OpenAI connection", "Use at the start of every connected conversation and before creating agents. It returns only masked provider status; if not configured, open tenant_provider_openai_setup_panel immediately.", object(), ["core:read"], true, true, { outputSchema: object({
    ok: { type: "boolean" },
