...
test("advertises explicit confirmation fields only on write tools", () => {
  ...
  assert.deepEqual(
    ...
    [
      "nyra_reliability_claim_record",
      "nyra_reliability_claim_verify",
      "nyra_reliability_action_issue",
      "nyra_reliability_action_consume",
      "nyra_reliability_handoff_issue",
      "nyra_reliability_handoff_consume",
      "nyra_reliability_completion_register",
      "nyra_reliability_completion_verify",
      "nyra_reliability_completion_finalize",
      "nyra_reliability_continuity_checkpoint",
      "nyra_reliability_continuity_replay",
      "nyra_reliability_budget_reserve",
      "nyra_reliability_browser_issue",
