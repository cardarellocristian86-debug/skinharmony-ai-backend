...
test("control-plane entrypoint rejects missing or mismatched dependency build identity before bootstrap", () => {
  for (const env of [
    {},
    ...
    assert.equal(result.stderr, "mcp_staging_db_bootstrap_failed\n");
