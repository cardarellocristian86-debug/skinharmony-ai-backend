...
test("workflow rotation promotes the deployed candidate before staging the next workflow", () => {
  assert.equal(HOST_NATIVE_GITHUB_WORKFLOW.sha256, "e0df2bb3b3e6a4dd2bbbd6dd9746e872e21fe1db9bf870c1cc0e5d94eb8c4190");
  assert.equal(HOST_NATIVE_GITHUB_WORKFLOW.candidate_sha256, "9cc98b219c7a9be5f3f562da3da36478a804796f8ebd1677fc1af3b05bc80cd4");
});
