export const SCOPES = Object.freeze({
  ...
  WRITE_INTELLIGENCE_OUTCOME: "write:intelligence_outcome",
  OWNER_ASSERTION: "owner:assertion",
...
export const DEFAULT_AUTOMATION_SCOPES = [
  ...
  SCOPES.WRITE_INTELLIGENCE_OUTCOME,
  SCOPES.READ_REVIEW,
  SCOPES.WRITE_REVIEW,
  SCOPES.WRITE_SYNC_SUITE,
  SCOPES.CLAIM_CHECK,
...
export const KEY_PRESETS = Object.freeze({
  ...
  nyra_core_360_connector: {
    label: "Nyra + Core 360 connector",
    key_type: "connector",
    tier: "omni_360",
    scopes: [
      SCOPES.READ_SNAPSHOT,
