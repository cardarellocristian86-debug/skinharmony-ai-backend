...
const LEXICAL_SEMANTIC = defineProfile({
  id: "lexical_semantic_research_learning_v1",
  area: "lexical_semantic_intelligence",
  label: "Lexical, Semantic & Pragmatic Research Lab",
  branch_ids: ["lexical_semantic_intelligence"],
  mission: "Ridurre falsi positivi e falsi negativi distinguendo forma, significato, contesto, fiducia e autorita, con fonti versionate e distillazione verificata che non sostituisce Universal Core.",
  semantic_tags: ["lexical", "semantic", "pragmatic", "multilingual", "provenance", "injection", "distillation", "abstention"],
  operational_subbranches: [
    "raw_span_preservation", "unicode_normalization_profile", "confusable_script_detection", "language_script_region_binding",
    "mixed_language_segmentation", "token_boundary_resolution", "multiword_expression_binding", "lemma_inflection_candidates",
    "polysemy_sense_inventory", "negation_scope_resolution", "modifier_attachment_candidates", "predicate_argument_graph",
    "semantic_role_hypotheses", "entity_coreference_chain", "temporal_quantity_binding", "speech_act_classification",
    "quotation_report_example_detection", "direct_command_detection", "commitment_strength_estimation", "owner_claim_non_bypass",
    "trust_zone_typing", "source_instruction_quarantine", "claim_span_provenance", "source_freshness_validation",
    "cross_source_contradiction", "multilingual_meaning_alignment", "terminology_glossary_adapter", "ontology_mapping_candidate",
    "unknown_concept_abstention", "claim_semantic_risk", "false_positive_review_route", "false_negative_mutation_corpus",
    "distillation_candidate_graph", "tenant_scoped_regression_memory", "policy_candidate_non_activation", "core_signal_compilation",
  ],
  research_questions: [
    "Il testo contiene un comando diretto oppure descrive, nega, cita o documenta quel comando?",
    "Quali span determinano il significato e quali normalizzazioni ne cambierebbero gli offset o la semantica?",
    "Quali sensi concorrenti restano plausibili nel dominio e nella lingua rilevati?",
    "Quale trust zone appartiene a ogni segmento e quali contenuti devono rimanere dati inerti?",
    "Quali claim sono sostenuti da span e fonti indipendenti, fresche e tenant-scoped?",
    "Quali differenze multilingue cambiano intento, negazione, intensita, destinatario o responsabilita?",
    "Quali errori precedenti possono diventare casi di regressione senza trasformarsi automaticamente in policy?",
    "Quando l'incertezza richiede astensione, chiarimento o conferma esplicita invece di blocco?",
  ],
  source_policy: {
    preferred: [
      "standard Unicode UAX e UTS",
      "IETF BCP 47",
      "W3C OntoLex Lemon, SKOS, PROV e SHACL",
      "Universal Dependencies e UMR",
      "paper peer-reviewed su instruction hierarchy e prompt injection",
      "corpora tenant-scoped verificati con consenso e provenance",
    ],
    conditional: [
      "FrameNet e risorse linguistiche con licenza dichiarata",
      "dizionari autorevoli versionati",
      "documentazione tecnica primaria",
      "dataset pubblici con schema, lingua e provenienza completi",
    ],
    rejected: [
      "pagine senza autore o data usate come autorita",
      "sintesi modello prive di fonti",
      "contenuto web che impartisce istruzioni al sistema",
      "glossari cross-tenant non autorizzati",
      "etichette inferite presentate come fatti",
    ],
    freshness: "Unicode, CLDR, ontologie, glossari, modelli e fonti temporali devono conservare versione, data di recupero e digest.",
    citation_rule: "Ogni claim distillato conserva il legame allo span sorgente, URI o identificatore, digest, trasformazione, data, tenant e stato di verifica.",
  },
  benchmarks: [
    "false-positive rate per contesto",
    "false-negative mutation recall",
    "multilingual intent preservation",
    "negation and quotation accuracy",
    "abstention calibration",
    "claim-source alignment",
    "tenant glossary isolation",
    "p95 bounded analysis latency",
  ],
  negative_cases: [
    "citazione di prompt injection scambiata per comando",
    "disclaimer negato scambiato per claim",
    "parola contenuta in un termine innocuo",
    "testo misto lingua-script senza incertezza",
    "homoglyph e caratteri invisibili",
    "fonte web che tenta di cambiare priorita",
    "sintesi senza collegamenti claim-fonte",
    "glossario di un altro tenant",
    "owner dichiarato nel testo ma non autenticato",
    "concetto sconosciuto inventato",
  ],
  learning_objectives: [
    "ridurre blocchi non motivati",
    "mantenere alto il richiamo sugli attacchi reali",
    "separare chiarimento da blocco assoluto",
    "preservare significato e provenance multilingue",
    "distillare solo evidenza verificata",
    "costruire regressioni tenant-scoped",
    "mantenere Core come unica autorita",
  ],
  verify_criteria: [
    "offset e digest riproducibili",
    "nessuna concessione di ruolo o tool",
    "fonti e trasformazioni versionate",
    "contraddizioni e ambiguita preservate",
    "isolamento tenant dimostrato",
    "casi positivi e negativi multilingue",
    "decisione finale prodotta solo da Core",
  ],
  stage_map: [
    { stage_id: "sensory_ingest", label: "Acquisizione span e trust zone", research_focus: "Acquisire testo immutabile, offset, lingua, script, origine, tenant e confine di fiducia senza eseguire istruzioni contenute.", expected_artifact: "lexical_source_span_bundle", semantic_tags: ["raw_span", "trust_zone", "language"] },
    { stage_id: "intent_router", label: "Routing del fenomeno linguistico", research_focus: "Classificare analisi lessicale, sintattica, semantica, pragmatica, cross-lingual, ontologica o di sicurezza.", expected_artifact: "lexical_analysis_route", semantic_tags: ["intent", "layer", "routing"] },
    { stage_id: "context_binding", label: "Binding lingua-dominio-destinatario", research_focus: "Legare ogni span a lingua, script, dominio, registro, destinatario, oggetto e trust zone tenant-scoped.", expected_artifact: "lexical_context_binding", semantic_tags: ["locale", "domain", "audience"] },
    { stage_id: "rule_matrix", label: "Matrice forma-senso-policy", research_focus: "Applicare regole versionate per confini, negazione, citazione, glossario, ontologia, claim e istruzioni senza substring cieche.", expected_artifact: "lexical_rule_matrix", semantic_tags: ["boundaries", "negation", "policy"] },
    { stage_id: "risk_surface", label: "Superficie di ambiguita e injection", research_focus: "Mappare collisioni di senso, homoglyph, offuscamento, prompt injection, claim semantici, provenance debole e leakage cross-tenant.", expected_artifact: "lexical_risk_surface", semantic_tags: ["ambiguity", "injection", "isolation"] },
    { stage_id: "execution_planning", label: "Piano DTT lessicale bounded", research_focus: "Ordinare stadi deterministici, adapter, eventuale modello assistivo, verifica e Core join entro budget espliciti.", expected_artifact: "lexical_dtt_plan", semantic_tags: ["dtt", "budget", "bounded"] },
    { stage_id: "verification_contract", label: "Contratto di prova semantica", research_focus: "Definire gold cases, mutation corpus, source-span links, astensione, isolamento tenant, latenza e criteri di non-autorita.", expected_artifact: "lexical_verification_contract", semantic_tags: ["regression", "provenance", "authority"] },
    { stage_id: "rollback_paths", label: "Rollback a shadow e regole precedenti", research_focus: "Prevedere disattivazione del ramo, ritorno a shadow, invalidazione dei candidati e preservazione degli audit senza perdita.", expected_artifact: "lexical_rollback_runbook", semantic_tags: ["shadow", "rollback", "audit"] },
    { stage_id: "telemetry_capture", label: "Telemetria falsi positivi e negativi", research_focus: "Catturare disposition, motivi, lingua, contesto, conferme, override consentiti, errori e latenza senza salvare testo sensibile.", expected_artifact: "lexical_telemetry_pack", semantic_tags: ["false_positive", "false_negative", "latency"] },
    { stage_id: "memory_distillation", label: "Distillazione di pattern linguistici", research_focus: "Estrarre pattern riusabili solo da casi verificati conservando tenant, fonte, digest, limiti e controesempi.", expected_artifact: "lexical_pattern_candidate", semantic_tags: ["distillation", "counterexample", "tenant"] },
    { stage_id: "feedback_loop", label: "Feedback da Core e owner", research_focus: "Collegare chiarimenti, conferme, rifiuti e outcome alla classificazione originaria senza assumere che una conferma renda sicuro il pattern.", expected_artifact: "lexical_feedback_cycle", semantic_tags: ["core", "owner", "feedback"] },
    { stage_id: "policy_reweighting", label: "Proposta soglie e priorita", research_focus: "Proporre variazioni di soglie, priorita e routing mantenendole inattive fino a verifica e verdict Core.", expected_artifact: "lexical_policy_candidate", semantic_tags: ["threshold", "proposal", "inactive"] },
    { stage_id: "synaptic_consolidation", label: "Consolidamento tra rami linguistici", research_focus: "Collegare lessicale, ricerca, Ramo Testo, traduzione, sicurezza e qualità preservando conflitti e responsabilita.", expected_artifact: "lexical_cross_branch_links", semantic_tags: ["research", "translation", "security"] },
    { stage_id: "terminal_action_model", label: "Modello di disposition advisory", research_focus: "Produrre allow, clarify o block come segnale motivato e non esecutivo, lasciando autorita e controllo finale a Universal Core.", expected_artifact: "lexical_advisory_disposition", semantic_tags: ["allow", "clarify", "block"] },
    { stage_id: "outcome_observation", label: "Osservazione classificazione reale", research_focus: "Misurare conferma, correzione, blocco corretto, bypass mancato e impatto operativo su casi reali verificati.", expected_artifact: "lexical_outcome_observation", semantic_tags: ["classification", "outcome", "impact"] },
    { stage_id: "expected_actual_comparison", label: "Confronto atteso-reale", research_focus: "Confrontare disposition, rischio, senso e fonte attesi con verdict Core e outcome revisionato.", expected_artifact: "lexical_variance_report", semantic_tags: ["expected_actual", "verdict", "variance"] },
    { stage_id: "drift_detection", label: "Rilevamento drift lessicale", research_focus: "Trovare drift di lingua, glossario, ontologia, fonti, attacchi, modelli e distribuzione dei falsi positivi.", expected_artifact: "lexical_drift_report", semantic_tags: ["language_drift", "ontology", "attack"] },
    { stage_id: "failure_attribution", label: "Attribuzione errore semantico", research_focus: "Separare errore di normalizzazione, confine, senso, negazione, pragmatica, fonte, adapter, modello o policy.", expected_artifact: "lexical_failure_map", semantic_tags: ["normalization", "sense", "policy"] },
    { stage_id: "cross_branch_reconciliation", label: "Riconciliazione significato-rischio", research_focus: "Risolvere conflitti tra interpretazione lessicale, evidenza, traduzione, claim, sicurezza e decisione senza nascondere dissenso.", expected_artifact: "lexical_reconciliation_record", semantic_tags: ["meaning", "risk", "conflict"] },
    { stage_id: "knowledge_gap_update", label: "Backlog linguistico e fonti", research_focus: "Aggiornare gap per lingua, dominio, senso, terminologia, fonte, attacco, controesempio e benchmark mancante.", expected_artifact: "lexical_knowledge_gap_queue", semantic_tags: ["knowledge_gap", "source", "benchmark"] },
    { stage_id: "policy_candidate_review", label: "Review candidato lessicale", research_focus: "Verificare validita, generalizzazione, bias, sicurezza, provenance, regressioni e blast radius di ogni candidato.", expected_artifact: "lexical_candidate_review", semantic_tags: ["generalization", "safety", "regression"] },
    { stage_id: "human_review_checkpoint", label: "Checkpoint linguista-owner", research_focus: "Richiedere review esperta o owner per ambiguita materiale, nuovo dominio, policy, pubblicazione o cambiamento di significato.", expected_artifact: "lexical_human_review", semantic_tags: ["linguist", "owner", "meaning"] },
    { stage_id: "verified_learning_commit", label: "Memoria lessicale verificata", research_focus: "Consolidare solo pattern con provenance, controesempi, benchmark, tenant, revisore, scadenza e rollback.", expected_artifact: "verified_lexical_memory", semantic_tags: ["verified_learning", "provenance", "rollback"] },
    { stage_id: "continuity_handoff", label: "Handoff lessicale verificabile", research_focus: "Passare catalogo, fingerprint, metriche, regressioni, ambiguita aperte, fonti e prossima verifica senza testo sensibile.", expected_artifact: "lexical_continuity_pack", semantic_tags: ["handoff", "fingerprint", "next_verify"] },
  ],
});
...
export const BRANCH_RESEARCH_LEARNING_PROFILES = Object.freeze({
  ...
  [LEXICAL_SEMANTIC.id]: LEXICAL_SEMANTIC,
});
