export const branchCodexArchitectureGuard = {
  ...
  subbranches: [
    "core_client_authority_boundary",
    "presentation_decision_separation",
    "multi_tenant_context_propagation",
    "shared_service_placement",
    "domain_adapter_isolation",
    "orchestrator_worker_contract",
    "runtime_topology_mapping",
    "data_owner_and_lineage",
    "identity_trust_boundary",
    "failure_domain_partition",
    "sync_snapshot_strategy",
    "cross_runtime_compatibility",
    "dependency_direction_audit",
    "architecture_decision_record",
    "migration_sequence_design",
    "release_boundary_review",
    "rollback_architecture_proof",
    "observability_ownership",
    "scalability_capacity_boundary",
    "technical_debt_containment",
  ],
  rules: [
