export function semanticDomainAllowlistForPrompt(text: string): string[] | undefined {
  ...
  if (/traduttore|translator|traduzione|translation|localizzazione|microcopy|ui label|help text|onboarding|plugin translator|sync_translations|localized_labels/i.test(raw)) return ["suite", "wordpress"];
