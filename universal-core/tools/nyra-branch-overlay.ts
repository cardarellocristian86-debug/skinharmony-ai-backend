...
const NYRA_META_BRANCHES: BranchSpec[] = [
  ...
  },
  {
    ...
    source_kind: "nyra_meta",
    terms: ["core", "decisione", "selezione", "giudice", "varianti", "ranking", "winner"],
  },
  {
    id: "codex_guidance",
    label: "Guida Codex",
    ...
    group_ids: ["software_cortex"],
    source_kind: "nyra_meta",
    terms: ["codex", "guida", "implementa", "verifica", "checkpoint", "patch locale"],
  },
  {
    id: "branch_overlay",
    ...
    group_ids: ["learning_cortex"],
    source_kind: "nyra_meta",
    terms: ["overlay", "rami", "sovrapporre", "sinapsi", "cortex", "cross branch"],
  },
  {
    id: "nyra_voice",
