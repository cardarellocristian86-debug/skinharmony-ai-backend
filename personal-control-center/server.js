...
function analyzerBranchMetaForKey(key = "") {
  return getAnalyzerBranchMetaByKeyData(key, {
...
function analyzerBranchMetaForId(id = "") {
  return getAnalyzerBranchMetaByIdData(id, {
...
function buildAnalyzerCoreOverlay(input = {}) {
  ...
  return buildAnalyzerCoreOverlayData({
    core_v2_digest: coreV2Digest,
    explicit_core_branches: explicitCoreBranches,
    v0_branches: v0Branches,
    v2_branches: v2Branches,
