...
const STABLE_USER_COMMUNICATION_POLICY: UserSandboxPolicy = "user_combined_candidate";
const SANDBOX_POLICY = (process.env.NYRA_USER_SANDBOX_POLICY ?? STABLE_USER_COMMUNICATION_POLICY) as UserSandboxPolicy;
...
function main(): void {
  ...
  const report = {
    ...
    setup: {
      ...
      days: 30,
      stable_user_communication_policy: STABLE_USER_COMMUNICATION_POLICY,
