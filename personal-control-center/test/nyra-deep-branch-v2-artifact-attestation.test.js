...
const catalogPath = path.resolve(
  process.env.NYRA_DEEP_V2_TEST_CATALOG_PATH
    || path.join(repoRoot, "personal-control-center/data/nyra-deep-branch-v2.catalog.json")
);
const reportPath = path.resolve(
  process.env.NYRA_DEEP_V2_TEST_VALIDATION_REPORT_PATH
    || path.join(repoRoot, "reports/nyra-deep-v2/validation_report.json")
);
